...
// Fri Jun 25 00:54:56 2021 by ROOT version 6.08/07
// from TTree Events/Events
// found on file: /publicfs/cms/data/TopQuark/nanoAOD/54CBFA91-4416-E811-AC85-0025905B8596.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         FatJet_msoftdrop_chs[6];   //[nFatJet]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[159];   //[nGenPart]
   Float_t         GenPart_mass[159];   //[nGenPart]
   Float_t         GenPart_phi[159];   //[nGenPart]
   Float_t         GenPart_pt[159];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[159];   //[nGenPart]
   Int_t           GenPart_pdgId[159];   //[nGenPart]
   Int_t           GenPart_status[159];   //[nGenPart]
   Int_t           GenPart_statusFlags[159];   //[nGenPart]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/publicfs/cms/data/TopQuark/nanoAOD/54CBFA91-4416-E811-AC85-0025905B8596.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/publicfs/cms/data/TopQuark/nanoAOD/54CBFA91-4416-E811-AC85-0025905B8596.root");
      }
