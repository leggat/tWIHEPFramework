...
#ifndef EventWeight_nanoAOD_h
#define EventWeight_nanoAOD_h
...
class EventWeight_nanoAOD : public HistoCut
{
...
public:
 ...
 // methods for weighting for MC generatd with MCatNLO
  ...
  inline std::string GetCutName() { return "EventWeight_nanoAOD"; };
