...
#endif
{
 ...
 // Check command line for Fast Running
  ...
  mystudy.SetNominalMuonCollection("MetMu");
  mystudy.SetNominalElectronCollection("MetEle");
  ...
  mystudy.AddAction(new MatchTriggerMuon(particlesObj,"MetMu")); // This just sets up one muon as the trigger matched
  ...
  mystudy.AddCut(new CutMuonN(particlesObj, "MetMu"));     //require that lepton to be isolated, central, high pt

  mystudy.AddCut(new CutMuonTrigger(particlesObj, "MetMu"));     //require that one muon is above the offline pt selection of the trigger

  mystudy.AddCut(new CutDiMuon(particlesObj, "MetMu"));    //make dimuon selections
 
  //  mystudy.AddCut(new CutElectronN(particlesObj, "Tight")); //require that lepton to be isolated, central, high pt

  mystudy.AddHists(new HistogrammingNPvtx(particlesObj));

  mystudy.AddHists(new HistogrammingMuon(particlesObj,"MetMu"));  // make the muon plots, hopefully.

  //  mystudy.AddCut(new CutJetN(particlesObj,nJets));

  mystudy.AddHists(new HistogrammingJet(particlesObj));

  mystudy.AddHists(new HistogrammingMETPaper(particlesObj,"Muon","MetMu"));
